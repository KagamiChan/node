...
(function(process) {
  ...
  NativeModule.wrap = function(script, id) {
    if (id !== 'buffer') {
      return NativeModule.wrapper[0] + script + NativeModule.wrapper[1];
    } else {
      return NativeModule.bufferWrapper[0] + script + NativeModule.wrapper[1];
    }
  };

  NativeModule.bufferWrapper = [
  ...
  NativeModule.prototype.compile = function() {
    ...
    source = NativeModule.wrap(source, this.id);
